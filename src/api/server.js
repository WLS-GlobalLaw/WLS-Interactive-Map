...
const clientEmail = process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL || process.env.REACT_APP_GOOGLE_SERVICE_ACCOUNT_EMAIL;

// regex/replace is there because netlify env on build was turning all /n's to //n's
const privateKey = process.env.GOOGLE_PRIVATE_KEY_LOCAL || process.env.REACT_APP_GOOGLE_PRIVATE_KEY.replace(new RegExp('\\\\n', 'g'), '\n');

const gsIdLawDS = process.env.GOOGLE_SHEET_ID_LAW_DS || process.env.REACT_APP_GOOGLE_SHEET_ID_LAW_DS;

const gsIdLawAS = process.env.GOOGLE_SHEET_ID_LAW_AS || process.env.REACT_APP_GOOGLE_SHEET_ID_LAW_AS;

const gsIdLawDG = process.env.GOOGLE_SHEET_ID_LAW_DG || process.env.REACT_APP_GOOGLE_SHEET_ID_LAW_DG;

const gsIdBodyText = process.env.GOOGLE_SHEET_ID_BODY_TEXT || process.env.REACT_APP_GOOGLE_SHEET_ID_BODY_TEXT;
